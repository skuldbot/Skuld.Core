...
namespace Skuld.Core.Utilities
{
	public static class DiscordUtilities
	{
		...
		public const string OkEmoji = "👌";
		public const string QuestionEmoji = "❓";
		public const string ConfusedEmoji = "⁉";
		public const string ProhibitEmoji = "🚫";
		public const string WarningEmoji = "⚠";
		public const string RemindEmoji = "🔔";
		public const string NotNSFWEmoji = "🔞";
		public const string ATMEmoji = "🏧";
		public const string NoBotsString = "Bots are not supported.";
